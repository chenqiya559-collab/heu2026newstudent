...
const ragSynonymGroups = [
  ...
  ['宿舍','公寓','寝室','宿寝','床位','独卫','独立卫生间','四人寝','四人间','上床下桌','阳台','查寝'], ['洗澡','洗浴','浴池','公共浴池','澡堂','北方澡堂','南方人洗澡','南方新生洗澡','开放式洗浴','无隔间','没有隔间','独立隔间','隐私'], ['洗衣机','洗衣','洗衣服','吹风机','吹头发','吹干头发'], ['电器','大功率','用电','插排','违规电器'],
...
function hasSpecificQuestionAnchor(question) {
  const normalized=ragNormalize(question); const anchors=['报到','材料','路线','机场','火车站','选课','培养方案','校园卡','饭卡','一卡通','餐卡','澡卡','校园码','充值','余额','挂失','补卡','电费','宿舍电费','公寓电费','电费账号','房间账号','gy0','欠费','断电','电费分摊','中国银行','中行','银行卡','储蓄卡','贷款','助贷','国家助贷','国助贷','学生贷款','生源地助学贷款','校园地助学贷款','国开行贷款','开行贷款','首贷','续贷','共同借款人','贷款合同','贷款申请','贷款额度','贷款到账','贷款回执','电子回执','回执单','回执码','受理证明','贷款证明','绿色通道','不交学费','暂缓缴费','缓交学费','贷款扣学费','贷款抵学费','奖学金','助学金','奖助学金','国家奖学金','国奖','国家励志','国励','国防科技奖学金','困难生','家庭经济困难','困难认定','贫困认定','智慧学工','校园网','无线','wifi','网费','网络费','宽带费','上网费','充网费','缴网费','网费账号','宿舍','寝室','独卫','四人寝','四人间','上床下桌','阳台','查寝','洗澡','洗浴','浴池','澡堂','北方澡堂','南方人洗澡','南方新生洗澡','隔间','无隔间','没有隔间','隐私','洗衣机','洗衣','吹风机','吹头发','快递','包裹','取件','驿站','社团','诈骗','哈军工','校训','学科','赞噢','集市','吃饭','食堂','餐厅','大美','小美','至美','快乐食间','小公交','校车','校园巴士','巴士','摆渡车','接驳车','购物','超市','新生采购','入学采购','集体售卖','统一购买','被子','被褥','床品','洗衣液','电话卡','手机卡','sim卡','网购','启航','北体育场','北体','剪头','理发','修手机','水果','外卖','外送','取餐','打印','复印','21b','教材','课本','二手书','图书馆','借书','借阅'];
